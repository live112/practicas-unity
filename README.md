...
2. [Desafío 2: Personajes y movimiento](#desafío-2--personajes-y-movimiento)  
3. [Desafío 3: Menú de inicio](#desafío-3--menú-de-inicio)

### 🎮 Tutoriales
3. [Tutorial 3: Recoger frutas (Items)](#tutorial-3--recoger-frutas-items)  
4. [Tutorial 4: Animaciones 2D](#tutorial-4--animaciones-2d)  
5. [Tutorial 5: Enemigos](#tutorial-5--enemigos)  
6. [Tutorial 6: Nuevos niveles](#tutorial-6--nuevos-niveles)  
7. [Tutorial 7: CheckPoint](#tutorial-7--checkpoint)  
8. [Tutorial 8: Transición](#tutorial-8--transición)  
9. [Tutorial 9: Doble salto y caída](#tutorial-9--doble-salto-y-caída)  
10. [Tutorial 10: Plataformas doble sentido](#tutorial-10--plataformas-doble-sentido)  
11. [Tutorial 11: Skins — Nuevos personajes](#tutorial-11--skins--nuevos-personajes)  
12. [Tutorial 12: Menú Principal (parte 1)](#tutorial-12--menú-principal-parte-1)  
12.2. [Tutorial 12, parte 2: Menú Principal](#tutorial-122--menú-principal-parte-2)  
14. [Tutorial 14: Botones para móvil](#tutorial-14--botones-para-móvil)  
15. [Tutorial 15: Score](#tutorial-15--score)  
29. [Tutorial 29: Vida](#tutorial-29--vida)
...
> Creación y control de animaciones básicas del personaje usando Animator Controller y transiciones.
...
> Implementación del movimiento del jugador, detección de suelo y animaciones de caminar/salto.
...
> Menú principal con botones, navegación entre escenas y configuración inicial del juego.
...
> Programación de ítems recolectables y su interacción con el jugador (puntuación).
...
> Manejo de parámetros en Animator, transiciones y estados para animaciones 2D.
...
> Creación de enemigos con detección de colisiones y lógica de daño.
...
> Gestión de múltiples niveles y preparación de escenas.
...
> Sistema de checkpoints y respawn utilizando `PlayerPrefs`.
...
> Transiciones visuales entre escenas y niveles.
...
> Doble salto, “better jump” y ajuste de gravedad para mejorar la sensación de control.
...
> Plataformas que permiten atravesar o cambiar de dirección (one-way / two-way).
...
> Sistema de selección/cambio de personaje con `PlayerPrefs` (sprites y `RuntimeAnimatorController`).
...
> Estructura del menú principal, navegación y escenas secundarias.
...
> Ampliación del menú principal: selección de personaje y opciones.
...
> Adaptación de controles a dispositivos móviles (joystick y botones táctiles).
...
> Sistema de puntuación y UI de contadores.
...
> Sistema de vida con corazones, animación de “Hit” y reinicio de escena.
